    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.light.background }}>
      <View style={styles.container}> 
        <ScrollView>        
              ...
              <Text style={styles.text}>A Escala de Coma de Glasgow fornece um índice clínico do comprometimento agudo 'geral' da função cerebral, ou o chamado 'nível de consciência'. Quando foi descrito, características de disfunção focal, como sinais de tronco encefálico, não foram incorporadas e, em vez disso, deveriam ser avaliadas separadamente. No entanto, tem havido opiniões de que os índices ou pontuações que combinam uma avaliação do "nível de consciência" e da função do "tronco cerebral" podem ter um lugar útil. 1-3 Em resposta, o GCS Pupils Score (GCS-P) foi construído para reunir informações sobre a capacidade de resposta do paciente conforme refletido no GCS Score e a reação da pupila.</Text>
              <Text style={styles.text}>A pontuação recebe 2 quando ambas as pupilas reagem a luminosidade, recebe 1 quando apenas uma pupila reage e 0 quando não há reatividade das pupilas </Text>
              <Text style={styles.text}>O GCS-P é calculado subtraindo a pontuação da reatividade da pupila (PRS) da pontuação total da Escala de Coma de Glasgow (GCS):</Text>
