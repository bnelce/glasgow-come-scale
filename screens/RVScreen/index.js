        ...
        <Wrapper>
          <Actions>
            ...
            <Action onPress={() => handleButton1("5")}>
              <ActionLabel>
                5 - Resposta adequada relativamente ao nome, local e data
              </ActionLabel>
            </Action>
            <Action onPress={() => handleButton1("4")}>
              <ActionLabel>
                4 - Resposta não orientada mas comunicação coerente
              </ActionLabel>
            </Action>
            ...
            <Action onPress={() => handleButton1("1")}>
              <ActionLabel>
                1 - Ausência de resposta auditível, sem fatores de interferência
              </ActionLabel>
            </Action>
            <Action onPress={() => handleButton1("0")}>
              <ActionLabel>
                NT - Fator que interfere com a comunicação
              </ActionLabel>
            </Action>
          </Actions>
        </Wrapper>
